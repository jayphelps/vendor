...
Ember.AnimatedContainerView = Ember.ContainerView.extend({
    ...
    _currentViewDidChange: Ember.observer(function() {
        ...
        if (newView) {
            if (oldView) {
                Ember.assert('Ember.AnimatedContainerView can only animate non-virtual views. You need to explicitly define your view class. ' + oldView, !oldView.isVirtual);
                Ember.assert('Ember.AnimatedContainerView can only animate non-virtual views. You need to explicitly define your view class.'  + newView, !newView.isVirtual);
